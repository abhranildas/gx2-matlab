...
% points against the same (w,k,lambda) -- e.g. gx2_dens_deriv's mixed-sign
...
%
% Usage:
% p=gx2_ruben(x,w,k,lambda,m)
% p=gx2_ruben(x,w,k,lambda,m,'upper')
% p=gx2_ruben(x,w,k,lambda,m,'output','pdf','nx',1)
%
% Required inputs:
...
coeffs=gx2_ruben_coeffs(w,k,lambda,'n_ruben',n_ruben);
